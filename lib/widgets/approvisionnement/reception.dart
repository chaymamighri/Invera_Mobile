  ...
  Widget build(BuildContext context) {
    ...
    final surface = Container(
      ...
      constraints: BoxConstraints(
        ...
        maxHeight: phone ? MediaQuery.sizeOf(context).height * 0.9 : 760,
      ),
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Les quantites confirmees seront ajoutees automatiquement au stock apres validation de la reception.',
                      style: TextStyle(
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  final tableWidth = phone ? 860.0 : constraints.maxWidth;
